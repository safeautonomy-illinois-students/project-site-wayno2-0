...
[[{{< fa video >}} Simulation (PID) Video]{.btn-text}](https://youtu.be/4og1H7TyQKY){.btn .btn-primary}
[[{{< fa video >}} Simulation (RL) Video]{.btn-text}](https://youtu.be/xnmZ3sgpZHI){.btn .btn-primary}
...
Furthermore, we have made preliminary progress in training a model-free Reinforcement Learning (RL) policy. 
Currently, our trained RL agent has successfully learned to navigate through the first two gates of the circuit. 
Demonstrations of both approaches are shown below.
:::
...
{{< video https://youtu.be/4og1H7TyQKY >}} 
:::

**Preliminary RL Policy (Successfully passing 2 gates):**

::: {.video-container}
{{< video https://youtu.be/xnmZ3sgpZHI >}}
:::
...
Currently, stable hover is achieved, and by scaling down the target velocity and setting yaw to 0, 
...
- [Autonomous Drone Racing with Deep Reinforcement Learning](https://doi.org/10.48550/arXiv.2103.08624) 
proposes a novel approach to near-time-optimal trajectory generation for quadrotors. 
By leveraging deep reinforcement learning and relative gate observations, 
this work heavily inspires our own model-free RL policy training and reward function design in CrazySim.
...
[2] Song, Y., Steinweg, M., Kaufmann, E., Scaramuzza, D. "Autonomous Drone Racing with Deep Reinforcement Learning." 
*IEEE/RSJ International Conference on Intelligent Robots and Systems (IROS)* (2021). [https://doi.org/10.48550/arXiv.2103.08624](https://doi.org/10.48550/arXiv.2103.08624)
:::
